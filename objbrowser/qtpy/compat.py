...
from objbrowser.qtpy import PYQT4
from objbrowser.qtpy.QtWidgets import QFileDialog
from objbrowser.qtpy.py3compat import is_text_string, to_text_string, TEXT_TYPES
...
def _qfiledialog_wrapper(attr, parent=None, caption='', basedir='',
    ...
    try:
        # PyQt <v4.6 (API #1)
        from objbrowser.qtpy.QtCore import QString
    except ImportError:
        # PySide or PyQt >=v4.6
